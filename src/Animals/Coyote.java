/**
 * This class represents the coyote class, which extends
...
public class Coyote extends Animal {
    ...
    public Coyote(String animalID, String animalNickname, String animalSpecies,boolean orp) throws InvalidAnimalTypeException {
